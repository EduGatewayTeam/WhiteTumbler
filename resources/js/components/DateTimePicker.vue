...
<template>
  <div>
    ...
    <div v-if="!isVisible" @click="changeVisibility" class="me-2">
      <svg class="dateTimeIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" width="1.5em" height="1.5em">
