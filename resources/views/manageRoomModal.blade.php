        ...
        <div v-if="activeRoom !== null" class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div v-for="(meeting, index) in meetings">
                    <div :id="`${meeting.id}`" v-if="meeting.isActive >= 0" class="p-2 d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            <div v-if="meeting.isActive > 0" class="spinner-grow spinner-grow-sm text-danger"
                                role="status">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            {{-- delete room action --}}
                            <delete-meeting :meetingId='`${meeting.id}`'></delete-meeting>
                            ...
                            >
                                ...
                                <svg v-else-if="meeting.isActive > 0" xmlns="http://www.w3.org/2000/svg" width="24"
