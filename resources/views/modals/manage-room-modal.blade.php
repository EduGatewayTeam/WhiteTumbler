                ...
                <div v-for="(item, index) in activeRoom.schedule">
                    ...
                    <div class="p-2 d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            >
                                <svg v-if="isMeetingActive(item.time_start, item.time_end) == 0" xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <svg v-else-if="isMeetingActive(item.time_start, item.time_end) > 0" xmlns="http://www.w3.org/2000/svg" width="24"
